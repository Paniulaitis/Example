...
public class SimpleLocatorsTypesTest {
    ...
    @Test
    public void searchByCssSelectorTestWTF(){
        driver.get("https://qaz.wtf/u/");
        logger.info("Открыта страница https://qaz.wtf/u/ - " + "https://qaz.wtf/u/");
        // Поиск элемента по CSS селектору
        WebElement element1 = driver.findElement(By.cssSelector("input#braille"));
        logger.info("WebElement: " + element1.getTagName());
        logger.info("Id: " + element1.getAttribute("id"));
        element1.sendKeys("braille");
        // Добавление задержки Thread.sleep, чтобы увидеть результат
        try {
            Thread.sleep(10000);
        } catch (InterruptedException e) {
    ...
    @Test
    public void searchByXpathQueryTestWTF(){
        driver.get("https://qaz.wtf/u/");
        logger.info("Открыта страница https://qaz.wtf/u/ - " + "https://qaz.wtf/u/");
        // Поиск элемента по XPATH запросу
        WebElement element1 = driver.findElement(By.xpath(".//input[@id='braille']"));
        logger.info("WebElement: " + element1.getTagName());
        logger.info("Id: " + element1.getAttribute("id"));
        element1.sendKeys("braille");
        // Добавление задержки Thread.sleep, чтобы увидеть результат
